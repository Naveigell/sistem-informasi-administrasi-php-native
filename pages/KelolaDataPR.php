        ...
        <center><?php
            if(isset($_GET['pesan'])){
                if($_GET['pesan']=="suksesedit"){
                    ...
                    echo "<div class='alert alert-danger'>Id site data PR tidak boleh sama !</div>";
                }
            }
            ?></center>
                                            ...
                                            <form method="POST" action="../aksi/pr/update.php?Id=<?= $SiteId;?>" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" data-site-id="<?= $SiteId;?>" name="SiteId" id="SiteId" placeholder="Masukkan Site Id" class="form-control site-id-update" value="<?= $result['SiteId']; ?>" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.site-id-update').on('keyup change', function (e) {
            ...
            $.ajax({
                url: './../aksi/pr/check_site_id.php?Id=' + Id,
                method: 'POST',
                data: {
                    SiteId: siteId,
                },
