                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" data-site-id="<?= $SiteId;?>" name="SiteId" id="SiteId" placeholder="Masukkan Site Id" class="form-control site-id-update" required value="<?= $result['SiteId']; ?>">
...
<script>
    $(document).ready(function () {
        $('.site-id-insert').on('keyup change', function (e) {
            ...
            $.ajax({
                url: './../aksi/mos/check_site_id.php',
                method: 'POST',
                data: {
                    SiteId: siteId,
                },
        ...
        $('.site-id-update').on('keyup change', function (e) {
            ...
            $.ajax({
                url: './../aksi/mos/check_site_id.php?Id=' + Id,
                method: 'POST',
                data: {
                    SiteId: siteId,
                },
