    ...
    <div id="content" class="p-4 p-md-5 pt-5 table-responsive">
        ...
        <center><?php
            if(isset($_GET['pesan'])){
                if($_GET['pesan']=="suksesedit"){
                    echo "<div class='alert alert-success'>Data SA sudah berhasil di Edit !</div>";
                }
                else if($_GET['pesan']=="suksestambah"){
                    echo "<div class='alert alert-success'>Data SA sudah berhasil di Tambahkan !</div>";
                }
                else if($_GET['pesan']=="gagaltambah"){
                    echo "<div class='alert alert-danger'>Data SA sudah pernah di Tambahkan !</div>";
                }
                else if($_GET['pesan']=="sukseshapus"){
                    echo "<div class='alert alert-success'>Data SA sudah berhasil di Hapus !</div>";
                }
                else if($_GET['pesan']=="duplicate"){
                    echo "<div class='alert alert-danger'>Id site data Sa tidak boleh sama !</div>";
                }
            }
            ?></center>
        <div class="table-responsive" >
            <table class="table table-bordered  table-striped table-hover">
                ...
                {
                    $getData = mysqli_query($db, "SELECT * FROM tb_sa ORDER by SiteId ASC");
                                ...
                                <div class="modal fade" id="hapus<?= $SiteId; ?>" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="../aksi/sa/delete.php?Id=<?= $SiteId;?>">
...
<!--                                                        <input type="text" name="Id" value="--><?//= $result['SiteId']; ?><!--" hidden="true">-->
                            ...
                            <div class="modal-content">
                                ...
                                <form method="POST" action="../aksi/sa/insert.php" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-success btn-sm" name="tambahsa">Tambah</button>
            ...
            <div style="float: left;">
                <button type="button" class="btn btn-success fa fa-plus fa-7x" data-target="#tambahkanuser" data-toggle="modal"> Tambah Data SA Baru </button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('.site-id-update').on('keyup change', function (e) {
            ...
            $.ajax({
                url: './../aksi/sa/check_site_id.php?Id=' + Id,
                method: 'POST',
                data: {
                    SiteId: siteId,
                }
