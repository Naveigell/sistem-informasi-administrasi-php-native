...
<div class="modal fade" id="Profil" role="dialog">
      ...
      <center><h3>Data Ekstrakurikuler</h3></center>
      <center><?php 
        if(isset($_GET['pesan'])){
...
<!--<th>Jadwal</th>-->
  ...
  <?php
  include '../koneksi/koneksikeloladaftar.php';
         ...
         <div class="modal fade" id="edit<?= $id; ?>" role="dialog">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form method="POST" action="../koneksi/koneksikeloladaftar.php?id=<?= $id;?>">
                <div class="modal-body">
                  <?php
...
<?php
  ...
  ?>  
<tr align="center">
  <form method="POST" action="../koneksi/koneksikeloladaftar.php">
